...
public class Profesor extends Usuario_base implements Permisos_estudiante_profesor {
    public static final int tipo_usuario = 2;
    private List<Libro> libros_reservados = new ArrayList<>();

    public void setLibros_reservados(List<Libro> libros_reservados) {
        this.libros_reservados = libros_reservados;
    }

    public Profesor(String nombre, int edad, long cedula) {
